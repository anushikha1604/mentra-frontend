  ...
  const jobs = [
    {
      ...
      description:
        'Join our team to build scalable systems serving millions of customers worldwide.',
      benefits: [
        'Health Insurance',
        'Stock Options',
        'Remote Work',
    ...
    },
    {
      ...
      description:
        'Build user interfaces that billions of people use every day.',
      benefits: [
        'Health Insurance',
        'Free Meals',
        'Gym Access',
    ...
    },
    {
      ...
      description:
        'Lead product initiatives and work with engineering teams to deliver innovative solutions.',
      benefits: [
        'Housing Stipend',
        'Health Insurance',
        'Mentorship',
    ...
    },
    {
      ...
      description:
        'Use data to improve our recommendation algorithms and user experience.',
      benefits: [
        'Unlimited PTO',
        'Stock Options',
    ...
    },
    {
      ...
      description:
        'Develop innovative iOS applications that delight millions of users.',
      benefits: [
        'Employee Discount',
        'Health Insurance',
        'Stock Options',

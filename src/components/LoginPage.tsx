...
export function LoginPage({ onNavigate }: LoginPageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (loginData.emailOrPhone === 'demo@mentra.com' || 
        ...
        setError('Invalid credentials. Try demo@mentra.com, admin@university.edu, or student@college.edu');
      }
    } catch (err) {
        ...
        <div className="w-full max-w-md">
          ...
          <Card className="border-2 border-gray-100 shadow-xl">
            <CardHeader className="text-center pb-4">
              ...
              <CardTitle className="font-heading text-xl text-primary-strong">Verify Your Identity</CardTitle>
            ...
            <CardContent>
              <form onSubmit={handleTwoFASubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="twoFACode" className="font-body text-primary-strong">Verification Code</Label>
                  <Input
                    id="twoFACode"
                    type="text"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-gray-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <Card className="border-2 border-gray-100 shadow-xl">
          <CardHeader className="text-center pb-4">
            <CardTitle className="font-heading text-xl text-primary-strong">Access Your Account</CardTitle>
            <CardDescription className="font-body text-secondary-medium">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="emailOrPhone" className="font-body text-primary-strong">Email, Phone, or Username</Label>
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={`pl-10 font-body ${validationErrors.emailOrPhone ? 'border-red-500' : ''}`}
                ...
                {validationErrors.emailOrPhone && (
                  <p className="font-body text-xs text-red-600">{validationErrors.emailOrPhone}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={`pl-10 pr-10 font-body ${validationErrors.password ? 'border-red-500' : ''}`}
                  ...
                  >
                    {showPassword ? <EyeOff className="w-4 h-4 text-muted-light" /> : <Eye className="w-4 h-4 text-muted-light" />}
                  </Button>
                </div>
                {validationErrors.password && (
                  <p className="font-body text-xs text-red-600">{validationErrors.password}</p>
                )}
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="rememberMe" className="font-body text-sm font-medium text-secondary-medium">
                    Remember me
                  </Label>
                </div>
                <button 
        ...
        <div className="mt-6 grid grid-cols-2 gap-4">
          <div className="text-center p-4 bg-white rounded-lg border border-gray-100 shadow-sm">
            ...
            <p className="font-body text-sm font-medium text-primary-strong">Students</p>
            <p className="font-body text-xs text-secondary-medium">Profile & career management</p>
          </div>
          <div className="text-center p-4 bg-white rounded-lg border border-gray-100 shadow-sm">
            <Building2 className="w-8 h-8 text-green-600 mx-auto mb-2" />
            <p className="font-body text-sm font-medium text-primary-strong">Institutions</p>
            <p className="font-body text-xs text-secondary-medium">Placement management & analytics</p>
          </div>
        </div>

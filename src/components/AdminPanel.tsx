...
export function AdminPanel() {
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-start gap-3 p-3 bg-green-50 rounded-lg">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">New placement at Google</p>
                <p className="text-xs text-gray-600">Alex Thompson was selected for SDE role • 2 hours ago</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 bg-blue-50 rounded-lg">
              <div className="w-2 h-2 bg-blue-500 rounded-full mt-2"></div>
              <div>
                <p className="text-sm font-medium text-gray-900">New job drive created</p>
                <p className="text-xs text-gray-600">Microsoft SDE position • 4 hours ago</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 bg-yellow-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">Amazon technical round for 15 candidates • 6 hours ago</p>
              </div>
            </div>
          </div>
        </CardContent>
  ...
  const renderStudentManagement = () => (
    <div className="space-y-6">
      ...
      <Card className="bg-white border border-gray-200 shadow-sm">
        <CardHeader>
          <CardTitle className="text-lg font-semibold text-gray-900">Student Database</CardTitle>
          <CardDescription className="text-sm text-gray-500">
            ...
            <table className="w-full">
              <thead className="border-b bg-gray-50">
                <tr>
                  ...
                  <th className="text-left p-4 font-semibold text-gray-900">CGPA</th>
                  <th className="text-left p-4 font-semibold text-gray-900">Status</th>
                  <th className="text-left p-4 font-semibold text-gray-900">Placement</th>
                  ...
                  <tr key={student.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="p-4">
                      {student.placementStatus === 'Placed' ? (
                        <div>
                          <div className="font-medium text-green-600">{student.company}</div>
                    ...
                    <td className="p-4">
                      <div className="flex items-center gap-2">
                        <Button variant="outline" size="sm" onClick={() => handleEditItem(student)}>
          ...
          <Card key={company.id} className="bg-white border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
            <CardContent className="p-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button variant="outline" size="sm" onClick={() => handleEditItem(company)}>
                  <Edit className="w-4 h-4" />
                </Button>
                <Button variant="ghost" size="sm">
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="space-y-2">
        ...
        <p className="text-gray-600">Comprehensive management dashboard for student placements</p>
      </div>
            ...
            <div className="space-y-6">
              <Card>
                ...
                <CardContent className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">Communication Management</h3>
                  <p className="text-gray-600 mb-4">Send notifications and manage announcements</p>
                  <Button>
            ...
            <div className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Generate and export placement reports</CardDescription>
                </CardHeader>
                <CardContent className="text-center py-12">
                  <FileSpreadsheet className="w-12 h-12 text-gray-400 mx-auto mb-4" />
                  <h3 className="text-lg font-medium text-gray-900 mb-2">Report Generation</h3>
                  <p className="text-gray-600 mb-4">Generate comprehensive placement reports</p>
            ...
            <div className="space-y-6">
              <Card>
                ...
                <CardContent className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-4">Manage system settings and preferences</p>
                  <Button>
